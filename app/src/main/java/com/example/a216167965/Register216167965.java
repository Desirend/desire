...
public class Register216167965 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register216167965);
    ...
    private void insertdata(String username, String password)
    {
        ...
        Intent intent = new Intent(Register216167965.this,MainActivity.class);
