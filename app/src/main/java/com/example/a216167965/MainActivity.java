package com.example.a216167965;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NeedNewAccount = (Button) findViewById(R.id.createNewAccount);
        ...
        NeedNewAccount.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(MainActivity.this,Register216167965.class);
    ...
    public void submit(){
        ...
        if (c != null){
            if (c.getCount() > 0){
                ...
                Intent intent = new Intent(MainActivity.this,Wellcome216167965.class);
                startActivity(intent);
            }
